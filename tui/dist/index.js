...
var require_InputBox = __commonJS({
  "src/components/InputBox.jsx"(exports2, module2) {
    ...
    var COMMANDS = [
      ...
      { cmd: "pentest --browser --url http://localhost:8080", desc: "Browser mode: headless Chrome renders + drives JS-heavy/SPA pages (browser_action, cookie bridge)" },
...
var require_CommandHelp = __commonJS({
  "src/components/CommandHelp.jsx"(exports2, module2) {
    ...
    var COMMANDS = [
      ...
      { cmd: "/pentest --browser --url http://localhost:8080", desc: "Browser mode: headless Chrome renders + DRIVES JS-heavy/SPA pages \u2014 render_page, browser_action (fill/click/submit), cookie bridge, DOM-XSS/clickjacking validators (install Chrome or set CIPHER_AI_CHROME)" },
...
var require_CommandPalette = __commonJS({
  "src/components/CommandPalette.jsx"(exports2, module2) {
    ...
    var COMMANDS = [
      ...
      { cmd: "pentest --browser --url http://localhost:8080", desc: "Browser mode: headless Chrome renders + drives JS-heavy/SPA pages (browser_action fill/click/submit, cookie bridge)" },
